...
To create a new category, you need to send a request to the [Creating a new category](https://developer.emporix.io/documentation-portal/api-references/api-guides-and-references/api-references/catalogs-and-categories/category-tree/api-reference/category-resources#post-category-tenant-categories) endpoint.
