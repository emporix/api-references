...
| -------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [AI Service](../artificial-intelligence/ai-service/)                                   | <a href="../artificial-intelligence/ai-service/api-reference/api.yml" class="button primary" data-icon="down-to-line">Download AI Service Specs</a> |
| [Approval Service](../companies-and-customers/approval-service/)                       |  <a href="../companies-and-customers/approval-service/approval-api-reference/api.yml" class="button secondary" data-icon="down-to-line">Download Approval Service Specs</a>  |
