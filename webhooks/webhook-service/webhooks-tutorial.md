...
To subscribe to an event, you need to send a request to the [Subscribing and unsubscribing from events]https://developer.emporix.io/api-references/api-guides-and-references/api-references/webhooks/webhook-service/api-reference/events#patch-webhook-tenant-event-subscriptions) endpoint.
