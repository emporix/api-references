...
layout:
  width: wide
description: You can use a standard q-param to filter search by string, localized, or numeric field values using exact matches, comparisons, and ranges.
---
...
<table>
  <thead>
    <tr>
      <th width="165.72796630859375">Search type</th>
      <th width="870.84863281">Example</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>
        <code>compoundLogicalQuery:((code:apple) OR (code:onion))</code>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <code>compoundLogicalQuery:((code:apple) OR (code:onion) OR (code:banana))</code>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <code>compoundLogicalQuery:((code:apple) AND (published:true) AND (version:1))</code>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <code>compoundLogicalQuery:((code:("apple","onion")) OR (id:("123","456")))</code>
      </td>
    </tr>
    <tr>
      <td>
        Single AND with COMPARISON
      </td>
      <td>
        <code>compoundLogicalQuery:((version:>=5) OR (version:<=2))</code>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        <code>compoundLogicalQuery:(((code:apple) AND (published:true)) OR ((code:onion) AND (published:false)))</code>
      </td>
    </tr>
  </tbody>
</table>