...
flowchart LR
 ...
 subgraph subGraph2["`**Customer's System**`"]
    ...
    ERP@{ shape: rounded}
     ...
     subGraph0:::Class_01
     subGraph2:::Class_02
    classDef Class_02 stroke-width:1px, stroke-dasharray: 0, stroke:#DDE6EE, fill:#DDE6EE, width:700px
    classDef Class_01 stroke-width:1px, stroke-dasharray: 0, stroke:#A1BDDC, fill:#A1BDDC, width:200px
    classDef Class_03 stroke-width:1px, stroke-dasharray: 0, stroke:#3b73bb, fill:#3b73bb, width:700px
    classDef Class_04 fill:#F2F6FA, stroke:#E86C07, width:150px
