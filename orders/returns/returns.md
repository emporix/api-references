...
When a customer sends a return request, the [Creating a single return entity](https://developer.emporix.io/api-references/api-guides-and-references/orders/returns/api-reference/returns#post-return-tenant-returns) endpoint is called.
...
To create a return on behalf of a customer, you need to send a request to the [Creating a single return entity](https://developer.emporix.io/api-references/api-guides-and-references/orders/returns/api-reference/returns#post-return-tenant-returns) endpoint.
