...
# 2026-04-27: Product Service – dynamic variant product type and recalculation
...
{% hint style="info" %}
See the tutorial section [How to work with dynamic variant products](https://developer.emporix.io/api-references/~/revisions/nE6EkbZhJyAJaCdxlAnT/api-guides/products-labels-and-brands/product-service/product#how-to-work-with-dynamic-variant-products).
{% endhint %}
