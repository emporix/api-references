...
| [Creating a shopping list](https://github.com/emporix/api-references/blob/main/openapi/shopping-list/README.md#operation/POST-shopping-list-create-shopping-list)                        | It creates a shopping list. The endpoint requires the `shoppinglist.shoppinglist_manage` scope by an employee.  |
...
| [Removing a shopping list](https://github.com/emporix/api-references/blob/main/openapi/shopping-list/README.md#operation/DELETE-shopping-list-remove-customer-shopping-list)             | It removes a shopping list. The endpoint requires the `shoppinglist.shoppinglist_manage` scope by an employee.  |
...
| Endpoint                                                                                                                                       |
| ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [Fetching all shopping lists](https://github.com/emporix/api-references/blob/main/openapi/shopping-list/README.md#operation/GET_shopping-list) |
| [Creating a shopping list](https://github.com/emporix/api-references/blob/main/openapi/shopping-list/README.md#operation/POST_shopping-list)   |
| [Updating a shopping list](https://github.com/emporix/api-references/blob/main/openapi/shopping-list/README.md#operation/PUT_shopping-list)    |
| [Removing a shopping list](https://github.com/emporix/api-references/blob/main/openapi/shopping-list/README.md#operation/DELETE_shopping-list) |
| [Fetching a shopping list](https://github.com/emporix/api-references/blob/main/openapi/shopping-list/README.md#operation/GET_shopping-lists)   |
...
| Endpoint                                                                                                                                           | Description                          |
| -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| [Creating a return](https://github.com/emporix/api-references/blob/main/openapi/returns/README.md#operation/POST-returns-create-return)            | We added `metadata.mixins` property. |
| [Retrieving returns](https://github.com/emporix/api-references/blob/main/openapi/returns/README.md#operation/GET-returns-list-returns)             | We added `metadata.mixins` property. |
| [Retrieving a return](https://github.com/emporix/api-references/blob/main/openapi/returns/README.md#operation/GET-returns-retrieve-return)         | We added `metadata.mixins` property. |
| [Updating a return](https://github.com/emporix/api-references/blob/main/openapi/returns/README.md#operation/PUT-returns-update-return)             | We added `metadata.mixins` property. |
| [Partially updating a return](https://github.com/emporix/api-references/blob/main/openapi/returns/README.md#operation/PATCH-returns-update-return) | We added `metadata.mixins` property. |
...
There are four new events which are emitted during: legal entity creation, legal entity update, legal entity deletion and when user is assigned to a legal entity. For more information, check out [Client Management Service events](https://github.com/emporix/api-references/blob/main/content/events-client-management/README.md).
...
| [Retrieving schemas](https://github.com/emporix/api-references/blob/main/openapi/schema/README.md#operation/GET-schema-retrieve-schemas)                      | It returns all schemas. The endpoint requires `schema.schema_read` scope.                            |
| [Retrieving a schema](https://github.com/emporix/api-references/blob/main/openapi/schema/README.md#operation/GET-schema-retrieve-schema)                      | It returns a schema. The endpoint requires `schema.schema_read` scope.                               |
| [Deleting a schema](https://github.com/emporix/api-references/blob/main/openapi/schema/README.md#operation/DELETE-schema-remove-schema)                       | It deletes a schema. The endpoint requires `schema.schema_manage` scope.                             |
...
| [Retrieving types](https://github.com/emporix/api-references/blob/main/openapi/schema/README.md#operation/GET-schema-retrieve-schema-types)                   | It returns types. The endpoint requires `schema.schema_read` scope.                                  |
| [Providing a file](https://github.com/emporix/api-references/blob/main/openapi/schema/README.md#operation/POST-schema-parse-schema-file)                      | It parses json schema and returns parsing results. The endpoint requires `schema.schema_read` scope. |
...
| [Retrieving references](https://github.com/emporix/api-references/blob/main/openapi/schema/README.md#operation/GET-schema-retrieve-references)                | It returns all references. The endpoint requires `schema.schema_read` scope.                         |
| [Retrieving a reference](https://github.com/emporix/api-references/blob/main/openapi/schema/README.md#operation/GET-schema-retrieve-reference)                | It returns a reference. The endpoint requires `schema.schema_read` scope.                            |
| [Deleting a reference](https://github.com/emporix/api-references/blob/main/openapi/schema/README.md#operation/DELETE-schema-remove-reference)                 | It deletes a reference. The endpoint requires `schema.schema_manage` scope.                          |
...
| Endpoint                                                                                                                                                           | Description               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------- |
| [Updating a customer profile](https://github.com/emporix/api-references/blob/main/openapi/customer-customer/README.md#operation/PATCH-customer-update-customer)    | We added `type` property. |
...
| [Creating a new customer](https://github.com/emporix/api-references/blob/main/openapi/customer-customer/README.md#operation/POST-customer-create-customer-account) | We added `type` property. |
...
| Endpoint                                                                                                                                                       | Description                                      |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| [Patch a customer profile](https://github.com/emporix/api-references/blob/main/openapi/customer-customer/README.md#operation/PATCH-customer-update-customer)   | Company registration ID property has been added. |
...
| [Post a new customer](https://github.com/emporix/api-references/blob/main/openapi/customer-customer/README.md#operation/POST-customer-create-customer-account) | Company registration ID property has been added. |
...
| Endpoint                                                                                                                                      | Description                                     |
| --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [Retrieving own scopes](https://github.com/emporix/api-references/blob/main/openapi/iam/README.md#operation/GET-iam-retrieve-own-user-scopes) | It allows the customer to get their own scopes. |

**Updated endpoints**

| Endpoint                                                                                                                                                               | Description                                                                                                                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| [Retrieving all groups](https://github.com/emporix/api-references/blob/main/openapi/iam/README.md#operation/GET-iam-list-tenant-user-groups)                           | The added `iam.group_read_own` scope allows customers to read the groups of customer types.                                                  |
| [Retrieving users assigned to a group](https://github.com/emporix/api-references/blob/main/openapi/iam/README.md#operation/GET-iam-list-group-users)                   | The added `iam.user_read_own` scope allows customers to read user assignments. The users have to be from the same company.                   |
...
| [Removing a user from a group](https://github.com/emporix/api-references/blob/main/openapi/iam/README.md#operation/DELETE-iam-remove-user-from-group)                  | The added `iam.assignment_delete_own` scope allows customers to unassign users from the group. The users have to be from the same company.   |
...
| Endpoint                                                                                                                                                | Description                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Creating an approval](https://github.com/emporix/api-references/blob/main/openapi/approval/README.md#operation/POST-approval-create-approval)          | It creates a new approval. The endpoint requires the `approval.approval_manage_own` scope.                                                                |
| [Retrieving a list of approvals](https://github.com/emporix/api-references/blob/main/openapi/approval/README.md#operation/GET-approval-list-approvals)  | It gets all the approvals assigned to the user. The endpoint requires the `approval.approval_read_own` scope.                                             |
| [Retrieving an approval](https://github.com/emporix/api-references/blob/main/openapi/approval/README.md#operation/GET-approval-retrieve-approval)       | It gets a single approval by ID assigned to the user. The endpoint requires the `approval.approval_read_own` scope.                                       |
| [Updating an approval](https://github.com/emporix/api-references/blob/main/openapi/approval/README.md#operation/PATCH-approval-update-approval)         | It updates an approval by ID. The endpoint requires the `approval.approval_manage_own` scope.                                                             |
| [Deleting an approval](https://github.com/emporix/api-references/blob/main/openapi/approval/README.md#operation/DELETE-approval-remove-approval)        | It deletes an approval by ID. The endpoint requires the `approval.approval_manage_own` scope.                                                             |
| [Checking the resource approval](https://github.com/emporix/api-references/blob/main/openapi/approval/README.md#operation/POST-approval-check-approval) | It checks if the user has permission to perform given action on the resource. The endpoint requires the `approval.approval_read_own` scope.               |
| [Searching for approver users](https://github.com/emporix/api-references/blob/main/openapi/approval/README.md#operation/POST-approval-search-users)     | It retrieves all the users who can approve the approval for a given action on the resource. The endpoint requires the `approval.approval_read_own` scope. |
...
| Endpoint                                                                                                                                          | Description                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| [Retrieving a list of returns](https://github.com/emporix/api-references/blob/main/openapi/returns/README.md#operation/GET-returns-list-returns)  | We added assisted buying property. |
| [Retrieving a single return](https://github.com/emporix/api-references/blob/main/openapi/returns/README.md#operation/GET-returns-retrieve-return) | We added assisted buying property. |
...
There are five new events which are emitted during: customer creation, customer update, customer deletion, sending a request to reset a customer's password and resending an account activation link to a customer. For more information, check out [Customer Service events](https://github.com/emporix/api-references/blob/main/content/events-customer/README.md).
...
| Endpoint                                                                                                                                                     | Description                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| [Generating text for an object description](https://github.com/emporix/api-references/blob/main/openapi/ai/README.md#operation/POST-ai-generate-description) | It generates a text based on a prompt. Currently supported AI engines for text generation: https://platform.openai.com/. |
...
| Endpoint                                                                                                                                                           | Description                                      |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------ |
| [Updating redemption option](https://github.com/emporix/api-references/blob/main/openapi/reward-points/README.md#operation/PUT-reward-points-update-redeem-option) | It updates redeem option with given information. |

**Updated endpoints**

| Endpoint                                                                                                                                                             | Description                                    |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| [Creating redemption option](https://github.com/emporix/api-references/blob/main/openapi/reward-points/README.md#operation/POST-reward-points-create-redeem-options) | It creates a redeem option for a given tenant. |
| [Retrieving redemption options](https://github.com/emporix/api-references/blob/main/openapi/reward-points/README.md#operation/GET-reward-points-list-redeem-options) | It gets a redeem option for a given tenant.    |
...
| Endpoint                                                                                                                                                               | Description                                        |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [Deleting redemption options](https://github.com/emporix/api-references/blob/main/openapi/reward-points/README.md#operation/DELETE-reward-points-remove-redeem-option) | It deletes redeem option by id for a given tenant. |
...
| Endpoint                                                                                                                                                              | Description                                                           |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| [Retrieving all delivery times](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/GET-shipping-list-delivery-times)            | It returns all the delivery times defined for the given tenant.       |
| [Creating a delivery time](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/POST-shipping-create-delivery-time)               | It creates a single delivery time.                                    |
| [Creating multiple delivery times](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/POST-shipping-create-delivery-times-bulk) | It creates multiple delivery times in a single request.               |
| [Getting a delivery time](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/GET-shipping-retrieve-delivery-time)               | It retrieves a specific delivery time.                                |
| [Updating a delivery time](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/PUT-shipping-update-delivery-time)                | It updates a single delivery time with a given information.           |
| [Partial updating of a delivery time](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/PATCH-shipping-update-delivery-time)   | It partially updates a single delivery time with a given information. |
...
| [Updating a delivery time](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/PUT-shipping-update-delivery-time)                           | It updates a single delivery time with a given information.              |
| [Partial updating of a delivery time](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/PATCH-shipping-update-delivery-time)              | It partially updates a single delivery time with a given information.    |
| [Deleting a delivery time](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/DELETE-shipping-remove-delivery-time)                        | It deletes a specific delivery time with all slots that it had created.  |
| [Getting all the delivery time slots](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/GET-shipping-retrieve-delivery-time-slots)        | It retrieves all the slots for a given delivery time.                    |
| [Creating a delivery time slot](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/POST-shipping-create-delivery-time-slot)                | It creates a new time slot for the given delivery time.                  |
| [Deleting all the delivery time slots](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/DELETE-shipping-remove-all-delivery-times-slots) | It deletes all the time slots for the given delivery time.               |
| [Getting a delivery time slot](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/PATCH-shipping-update-delivery-time-slot)                | It retrieves the given delivery time slot's details.                     |
| [Updating a delivery time slot](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/PUT-shipping-update-delivery-time-slot)                 | It updates a single delivery time slot with given information.           |
| [Partial updating of a delivery time slot](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/PATCH-shipping-update-delivery-time-slot)    | It partially updates a single delivery time slot with given information. |
| [Deleting a delivery time slot](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/DELETE-shipping-remove-delivery-times-slot)             | It deletes a single delivery time slot.                                  |
| [Generating a delivery cycle](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/POST-shipping-generate-delivery-cycle)                    | It generates a delivery cycle.                                           |

**Updated endpoints**

| Endpoint                                                                                                                                                                                        | Description                                                                                                                                                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Increasing the delivery window counter](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/POST-shipping-increase-orders-number-in-delivery-window)         | Request body contains one new property - `slotId`.                                                                                                                                                            |
| [Retrieving delivery windows by cart](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/GET-shipping-retrieve-actual-delivery-window)                    | Response contains new properties - `slotId`, `deliveryMethod`, `cutOffTime`, `cutOfDay`, `deliveryCycle`.                                                                                                     |
| [Retrieving delivery windows by delivery area](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/GET-shipping-retrieve-delivery-times-for-delivery-area) | Endpoint was deprecated.                                                                                                                                                                                      |
| [Finding sites by postal code](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/POST-shipping-find-sites)                                               | Response contains new properties - `zones.actualDeliveryWindows.deliveryCycle`, `zones.actualDeliveryWindows.deliveryMethod`, `zones.actualDeliveryWindows.cutOffTime`, `zones.actualDeliveryWindows.slotId`. |
| [Retrieving orders](https://github.com/emporix/api-references/blob/main/openapi/order/README.md#operation/GET_tenant-salesorders)                                                               | Response contains a new property - `deliveryWindow`.                                                                                                                                                          |
...
| [Updating an order](https://github.com/emporix/api-references/blob/main/openapi/order/README.md#operation/PUT-order-update-order)                                                               | Request body contains a new property - `deliveryWindow`.                                                                                                                                                      |
...
| Endpoint                                                                                                                                                                               | Description                                                                                                                                                                                                |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Creating a new payment mode](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#tag/Payment-mode)                                                  | It creates a new payment mode. The endpoint requires `payment-gateway.paymentmodes_manage` scope.                                                                                                          |
| [Updating an existing payment mode](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/PUT-payment-gateway-update-payment-mode)           | It updates an existing payment mode. The endpoint requires `payment-gateway.paymentmodes_manage` scope.                                                                                                    |
| [Deleting an existing payment mode](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/DELETE-payment-gateway-remove-payment-mode)        | It deletes an existing payment mode. The endpoint requires `payment-gateway.paymentmodes_manage` scope.                                                                                                    |
| [Fetching payment modes](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/GET-payment-gateway-list-payment-modes)                       | It fetches a list of configured payment modes. The endpoint requires `payment-gateway.paymentmodes_read` scope.                                                                                            |
| [Fetching payment mode](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/GET-payment-gateway-retrieve-payment-mode)                     | It fetches a single, configured payment mode. The endpoint requires `payment-gateway.paymentmodes_read` scope.                                                                                             |
| [Fetching payment modes publicly](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/GET-payment-gateway-retrieve-payment-modes-frontend) | It fetches a list of configured payment modes. The endpoint does not require any scope to be invoked and it returns properties that can be considered as publicly available. It can be used on a frontend. |
| [Fetching payment modes publicly](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/GET-payment-gateway-retrieve-payment-mode-frontend)  | It fetches a single, configured payment mode. The endpoint does not require any scope to be invoked and it returns properties that can be considered as publicly available. It can be used on a frontend.  |
| [Authorizing a payment](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#tag/Payment)                                                             | It authorizes a given payment. The endpoint requires `payment-gateway.authorize_manage` scope.                                                                                                             |
| [Capturing a payment](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/POST-payment-gateway-capture-payment)                            | It captures a given payment. The endpoint requires `payment-gateway.capture_manage` scope.                                                                                                                 |
| [Refunding a payment](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/POST-payment-gateway-refund-payment)                             | It refunds a given payment. The endpoint requires `payment-gateway.refund_manage` scope.                                                                                                                   |
| [Cancelling a payment](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/POST-payment-gateway-cancel-payment)                            | It captures a given payment. The endpoint requires `payment-gateway.cancel_manage` scope.                                                                                                                  |
| [Fetching transactions](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/GET-payment-gateway-list-transactions)                         | It fetches a list of payment transactions. The endpoint requires `payment-gateway.paymenttransactions_read` scope.                                                                                         |
| [Fetching transaction](https://github.com/emporix/api-references/blob/main/openapi/payment-gateway/README.md#operation/GET-payment-gateway-retrieve-transaction-by-transactionId)      | It fetches a single payment transaction. The endpoint requires `payment-gateway.paymenttransactions_read` scope.                                                                                           |
...
The event is emitted when an order is being deleted. For more information, check out [Order Service events](https://github.com/emporix/api-references/blob/main/content/events-order/README.md).
...
| Endpoint                                                                                                                   | Description                                             |
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| [Creating a new category](https://github.com/emporix/api-references/blob/main/openapi/category/README.md#operation/create) | The category resource now contains the `code` property. |
...
| Endpoint                                                                                                                                                 | Description                                                                                       |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [Retrieving all groups](https://github.com/emporix/api-references/blob/main/openapi/iam/README.md#operation/GET-iam-list-tenant-user-groups)             | The `b2b.legalEntityId` property indicates the legal entity for which the group has been created. |
| [Retrieving a group](https://github.com/emporix/api-references/blob/main/openapi/iam/README.md#operation/GET-iam-retrieve-user-group)                    | The `b2b.legalEntityId` property indicates the legal entity for which the group has been created. |
...
| Endpoint                                                                                                                                                                   | Description                                                                                                                  |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [Retrieving all legal entities](https://github.com/emporix/api-references/blob/main/openapi/customer-management/README.md#operation/GET-customer-mgmt-list-legal-entities) | There is a possibility to retrieve legal entities of the customer using new `customermanagement.legalentity_read_own` scope. |
...
| Endpoint                                                                                                                                            | Description                          |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| [Creating a quote reason](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/POST-quote-create-quote-reason)     | It creates a new quote reason.       |
| [Updating a quote reason](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/PUT-quote-update-reason)            | It updates an existing quote reason. |
| [Deleting a quote reason](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/DELETE-quote-remove-reason)         | It deletes an existing quote reason. |
| [Retrieving quote reasons](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/GET-quote-list-reasons)            | It gets a list of quote reasons.     |
| [Retrieving a single quote reason](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/GET-quote-retrieve-reason) | It gets a single quote reason.       |

**Updated endpoints**

| Endpoint                                                                                                                                                               | Description                                                                                                                                                                         |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Partially updating a quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/PATCH-quote-update-quote)                           | The quote has the `quoteReasonId` property as part of the status which should be provided when changing status of the quote to `DECLINED`, `DECLINED_BY_MERCHANT` or `IN_PROGRESS`. |
...
| [Partially updating a quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/PATCH-quote-update-quote)                           | The `shipping` object can be updated by the PATCH endpoint.           |
| [Creating a quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/POST-quote-create-quote)                                      | A new optional field `shipping` was added for quote creation.         |
...
| Endpoint                                                                                                                                         | Description                                                                                                                                                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Triggering a checkout](https://github.com/emporix/api-references/blob/main/openapi/checkout/README.md#operation/POST-checkout-trigger-checkout) | The `triggering a checkout` request contains the optional `quoteId` field. In case of triggering a checkout of the quote, the `shipping`, `addresses`, and `customer` information is fetched directly from the quote. |
...
| [Partially updating a quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/PATCH-quote-update-quote)                           | New paths provide support for updating mixins and mixins metadata. |
| [Creating a quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/POST-quote-create-quote)                                      | New properties provide support for mixins and mixins metadata.     |
...
| Endpoint                                                                                                                                                               | Description                       |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| [Creating a quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/POST-quote-create-quote)                                      | It creates a new quote.           |
| [Partially updating a quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/PATCH-quote-update-quote)                           | It updates an existing quote.     |
| [Deleting a quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/DELETE-quote-remove-quote)                                    | It deletes an existing quote.     |
...
| [Creating a quote PDF](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/POST-quote-generate-quote-pdf)                            | It generates a quote PDF.         |
