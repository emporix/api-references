...
| [Upserting a product](https://github.com/developer.emporix.io/api-references/api-guides/products-labels-and-brands/product-service/api-reference/products/README.md#put-product-tenant-products-productid) | The endpoint requires a new `product.product_manage` scope, as the `product.product_update` scope is deprecated. Sending a request to the upsert endpoint with a non-existing product id creates a new product with the given id. |
...
| [Deleting a product](https://github.com/emporix/api-references/blob/main/openapi/product/README.md#operation/DELETE-product-remove-product)                                                                | The endpoint requires a new `product.product_manage` scope, as the `product.product_delete` scope is deprecated.                                                                                                                  |
...
| [Removing a user from a group](https://github.com/emporix/api-references/blob/main/openapi/iam/README.md#operation/DELETE-iam-remove-user-from-group)                                                        | The endpoint requires a new `iam.assignment_manage` scope, as the `iam.assignment_delete` scope is deprecated.                                                                                                      |
...
| [Deleting all category assignments](https://github.com/emporix/api-references/blob/main/openapi/category/README.md#operation/DELETE-category-tree-remove-all-category-assignments)                                                                                     | The endpoint requires a new `category.category_manage` scope, as the `category.category_update` scope is deprecated.                                                                                                                                 |
...
| [Updating an order](https://github.com/emporix/api-references/blob/main/openapi/order/README.md#operation/PUT-order-update-order)                                              | The `discount.discountCalculationType` field added. |
...
| [Retrieving all discounts](https://github.com/emporix/api-references/blob/main/openapi/cart/README.md#operation/GET-cart-list-all-discounts)                | The `discountCalculationType` field added.                                |
...
The event is emitted when a customer requests changing the email. For more information, see [Customer events](https://github.com/emporix/api-references/blob/main/content/events-customer/README.md).
...
| [Updating an order](https://github.com/emporix/api-references/blob/main/openapi/order/README.md#operation/PUT-order-update-orde)                                                     | The request body schema contains `feeYrnAggregate` and `fees` fields.  |
...
| [Retrieving a cart item](https://github.com/emporix/api-references/blob/main/openapi/cart/README.md#operation/GET-cart-retrieve-item-details)                                | The response body schema contains new field `externalFees`.                  |
...
The event is emitted when a customer confirms changing the email. For more information, see [Customer events](https://github.com/emporix/api-references/blob/main/content/events-customer/README.md).
...
| [Upserting a product](https://github.com/developer.emporix.io/api-references/api-guides/products-labels-and-brands/product-service/api-reference/products/README.md#put-product-tenant-products-productid) | The request body schema contains two new fields `brandId` and `labelIds`.  |
...
| Endpoint                                                                                                                                          | Description                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| [Retrieving customers](https://github.com/emporix/api-references/blob/main/openapi/cart/README.md#operation/GET_tenant-customers)                 | Response payload contains the `metadataCreatedAt` field. |
| [Retrieving a customer](https://github.com/emporix/api-references/blob/main/openapi/cart/README.md#operation/GET_tenant-customers-customerNumber) | Response payload contains the `metadataCreatedAt` field. |
...
| Endpoint                                                                                                                                | Description                                           |
| --------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| [Adding entries](https://github.com/emporix/api-references/blob/main/openapi/order/README.md#operation/POST-order-update-order-entries) | A new endpoint for adding entries to existing orders. |
...
| Endpoint                                                                                                                                           | Description                            |
| -------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| [Retrieving clients](https://github.com/emporix/api-references/blob/main/openapi/configuration/README.md#operation/GET-configuration-list-clients) | A new endpoint for retrieving clients. |
...
| Endpoint                                                                                                                                                            | Description                                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [Requesting password reset](https://github.com/emporix/api-references/blob/main/openapi/customer-customer/README.md#operation/POST-customer-request-reset-password) | The `site` property added to password reset model. |
...
| Endpoint                                                                                                                        | Description                                                   |
| ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| [Refreshing a cart](https://github.com/emporix/api-references/blob/main/openapi/cart/README.md#operation/PUT-cart-refresh-cart) | A new endpoint that refreshes a specified cart and its items. |
...
| Endpoint                                                           |
| ------------------------------------------------------------------ |
| Fetching all shopping lists - _GET_ _/shoppinglists_               |
| Creating a shopping list - _POST_ _/shoppinglists_                 |
| Updating a shopping list - _PUT_ _/shoppinglists_                  |
| Removing a shopping list - _DELETE_ _/shoppinglists_               |
| Fetching a shopping list - _GET_ _/shoppinglists/{customerNumber}_ |
...
| Endpoint                                                                                                                                                                              | Description                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| [Calculating the shipping cost for a given slot](https://github.com/emporix/api-references/blob/main/openapi/shipping/README.md#operation/POST-shipping-calculate-slot-shipping-cost) | A new endpoint that retrieves the minimum delivery cost for a given time slot. |
...
| [Creating a shopping list](https://github.com/emporix/api-references/blob/main/openapi/shopping-list/README.md#operation/POST-shopping-list-create-shopping-list)                        | We added the `mixins` and `metadata.mixins` properties. |
...
| Endpoint                                                                                                                                           | Description                                                               |
| -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [Retrieving all cart discounts](https://github.com/emporix/api-references/blob/main/openapi/cart/README.md#operation/GET-cart-list-all-discounts)  | New endpoint for getting all discounts from a cart.                       |
| [Deleting discount by code](https://github.com/emporix/api-references/blob/main/openapi/cart/README.md#operation/DELETE-cart-remove-all-discounts) | New query param `codes` that allows to remove discounts by provided code. |
...
| Endpoint                                                                                                                                                                 | Description                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------- |
| [Retrieving all price lists](https://github.com/emporix/api-references/blob/main/openapi/price/README.md#operation/GET-price-retrieve-price-lists)                       | We added the `mixins` and `metadata.mixins` properties. |
| [Retrieving price list by id](https://github.com/emporix/api-references/blob/main/openapi/price/README.md#operation/GET-price-retrieve-price-list)                       | We added the `mixins` and `metadata.mixins` properties. |
| [Creating a price list](https://github.com/emporix/api-references/blob/main/openapi/price/README.md#operation/POST-price-create-price-list)                              | We added the `mixins` and `metadata.mixins` properties. |
...
The event is emitted when a customer opts in. For more information, see [Customer events](https://github.com/emporix/api-references/blob/main/content/events-customer/README.md).
...
| Endpoint                                                                                                                                         | Description                                                                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Triggering a checkout](https://github.com/emporix/api-references/blob/main/openapi/checkout/README.md#operation/POST-checkout-trigger-checkout) | The `customer` object contains the `guest` field. If set to `true`, the checkout process proceeds for a guest customer without the need for registering or logging in. |
...
| Endpoint                                                                                                                                              | Description                                                               |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [Creating a single return entity](https://github.com/emporix/api-references/blob/main/openapi/returns/README.md#operation/POST-returns-create-return) | New `requestor.anonymous` and `requestor.email` parameters are available. |
...
| Endpoint                                                                                                                                           | Description                                        |
| -------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [Refreshing an anonymous token](https://github.com/emporix/api-references/blob/main/openapi/oauth/README.md#operation/refreshAnonymousAccessToken) | The `anonymous_token` parameter is now deprecated. |
...
We updated the Quote Service so that it allows for using a service token (generated from the API Keys in Developer Portal), which is not linked to any specific user. You can perform all Quote Service API operations using the service token. The merchant and customer access tokens can still be used with the Quote API. For more information, see [Developer Portal](https://developer.emporix.io/user-guides/getting-started/developer-portal/manage-apikeys).

**Updated endpoints**

| Endpoint                                                                                                                              | Description                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| [Creating a new quote](https://github.com/emporix/api-references/blob/main/openapi/quote/README.md#operation/POST-quote-create-quote) | Use the `customerEmail` property to generate a quote for a user's contact email address instead of the customer ID. |
...
| Endpoint                                                                                                                                             | Description                       |
| ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| [Creating invoice job](https://github.com/emporix/api-references/blob/main/openapi/invoice/README.md#operation/POST-invoice-create-job)              | It creates a new invoice job.     |
| [Retrieving invoice job](https://github.com/emporix/api-references/blob/main/openapi/invoice/README.md#operation/GET-invoice-retrieve-job-and-order) | It retrieves invoice job details. |
...
| [Reindexing](https://github.com/emporix/api-references/blob/main/openapi/indexing/README.md#operation/POST-indexing-reindex)                                                                              | It triggers reindex operation.         |
