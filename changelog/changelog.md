...
The AI Service API now allows you to provide JSON Schema in the `outputFormat` field that constrains the structure of the agent response. This allows clients to specify the desired format of the output generated by the AI service, enabling better integration with various applications and workflows.

#### Updated endpoints

| Endpoint                                                                                                                                                                                 | Description                                 |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| [Retrieving agent by ID](https://developer.emporix.io/api-references/api-guides/artificial-intelligence/ai-service/api-reference/agent#get-ai-service-tenant-agentic-agents-agentid)     | Response includes now `outputFormat` field. |
| [Listing Agents](https://developer.emporix.io/api-references/api-guides/artificial-intelligence/ai-service/api-reference/agent#get-ai-service-tenant-agentic-agents)                     | Response includes now `outputFormat` field. |
| [Searching Agents](https://developer.emporix.io/api-references/api-guides/artificial-intelligence/ai-service/api-reference/agent#post-ai-service-tenant-agentic-agents-search)           | Response includes now `outputFormat` field. |
| [Upserting agent](https://developer.emporix.io/api-references/api-guides/artificial-intelligence/ai-service/api-reference/agent#put-ai-service-tenant-agentic-agents-agentid)            | Request includes now `outputFormat` field.  |
| [Partially updating agent](https://developer.emporix.io/api-references/api-guides/artificial-intelligence/ai-service/api-reference/agent#patch-ai-service-tenant-agentic-agents-agentid) | Request includes now `outputFormat` field.  |
