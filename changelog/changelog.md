...
| [Retrieving a list of categories](https://developer.emporix.io/api-references/api-guides/catalogs-and-categories/category-tree/api-reference/category-resources#get-category-tenant-categories)                                  | Response `media` items include a `mixins` field populated from linked Media Service assets.                                                 |
| [Retrieving a category's details](https://developer.emporix.io/api-references/api-guides/catalogs-and-categories/category-tree/api-reference/category-resources#get-category-tenant-categories-categoryid)                   | Response `media` items include a `mixins` field populated from linked Media Service assets.                                                 |
| [Retrieving a product](https://developer.emporix.io/api-references/api-guides/products-labels-and-brands/product-service/api-reference/products#get-product-tenant-products-productid)                                       | Response `media` items include a `mixins` field populated from linked Media Service assets.                                                 |
| [Retrieving all products](https://developer.emporix.io/api-references/api-guides/products-labels-and-brands/product-service/api-reference/products#get-product-tenant-products)                                                | Response `media` items include a `mixins` field populated from linked Media Service assets.                                                 |
| [Searching for products](https://developer.emporix.io/api-references/api-guides/products-labels-and-brands/product-service/api-reference/products#post-product-tenant-products-search)                                        | Response `media` items include a `mixins` field populated from linked Media Service assets.                                                 |
