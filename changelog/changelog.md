...
{% update date="2026-06-21" tags="improvement" %}
...
| Endpoint path pattern                         | Description                              | Change summary                                      |
|----------------------------------------------|------------------------------------------|----------------------------------------------------|
| `{tenant}/custom-entities/{type}/instances/bulk`  | Bulk create and upsert custom entity instances | Increased maximum bulk payload size from 1000 to 5000 items; updated API documentation and validation error message accordingly |
