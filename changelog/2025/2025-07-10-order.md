...
# 2025-07-10: Order Service - vendor added

## Overview

A new attribute `vendor` has been added to the order object. A vendor employee can see and modify only orders that belong to their vendor.
