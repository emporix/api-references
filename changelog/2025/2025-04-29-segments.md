...
All the previously added endpoints were changed from the preview mode to fully operational. See the [Customer Segments API Reference](../../companies-and-customers/customer-segments/api-reference/README.md).                            |
