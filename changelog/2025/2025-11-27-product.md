...
# 2025-11-27: Product Service – category and customer segment IDs in product response
...
Both attributes are read-only, available only in product retrieval responses as they are populated automatically when category or customer segment assignment is created.
Currently they remain in preview mode as they are not fully operational yet.
